...
# Используем только нормальные данные для обучения
normal_data = filtered_data[filtered_metadata == 1]

# Разбиваем нормальные данные на обучающую и валидационную выборки только с нормальными данными
train_data, val_data = train_test_split(
    normal_data, test_size=0.3, random_state=seed)
